...
function NewEvaluationPageInner() {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      {/* Sticky save bar */}
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-hub-border bg-white/95 backdrop-blur-md px-4 py-3 flex items-center gap-3"
        ...
        <div className="flex items-center gap-3 ml-auto">
          {selectedPlayerId && (
            <div className="hidden sm:flex items-center gap-2 text-xs text-slate-500">
              <div className="w-2 h-2 rounded-full bg-hub-teal" />
              Overall: <span className="font-bold text-slate-900">{fifaRating}</span>
            </div>
          )}
          <button
            type="button"
            className="hub-btn-outline flex items-center gap-2 disabled:opacity-40 py-2.5"
          ...
          <button
            ...
            className="hub-btn-primary flex items-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed px-6 py-2.5"
          >
